...
const ctxMap = new WeakMap<any, any>()

const Grainient: React.FC<Props> = ({
  timeSpeed = 0.25,
  colorBalance = 0.0,
  warpStrength = 1.0,
  warpFrequency = 5.0,
  ...
  useEffect(() => {
    ...
    const Renderer = (OGL as any).Renderer
    const Program = (OGL as any).Program
    const Mesh = (OGL as any).Mesh
    const Triangle = (OGL as any).Triangle
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uZoom:           { value: 0.9 },
        uColor1:         { value: new Float32Array(hexToRgb('#172554')) },
        uColor2:         { value: new Float32Array(hexToRgb('#0B0B0B')) },
        uColor3:         { value: new Float32Array(hexToRgb('#000000')) }
      }
    })
  ...
  useEffect(() => {
    ...
    u.uColor1.value = new Float32Array(hexToRgb('#000000'))
    u.uColor2.value = new Float32Array(hexToRgb('#1c2059'))
    u.uColor3.value = new Float32Array(hexToRgb('#61499d'))
  }, [
